...
return function(focus: GuiObject, onClick: () -> nil, Visible: State<boolean>): ScreenGui
	...
	local out = _new("ScreenGui")({
		Parent = if RunService:IsRunning() then game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui") else game:GetService("CoreGui"),
	...
	local playerGui: PlayerGui? = if RunService:IsRunning() then game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui") :: PlayerGui else nil
