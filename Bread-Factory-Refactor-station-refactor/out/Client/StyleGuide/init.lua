...
local PRIMARY_DEFAULT_COLOR = Color3.fromHex("#ab80ee")
local SECONDARY_DEFAULT_COLOR = Color3.fromHex("#2fbec9")
local TERTIARY_DEFAULT_COLOR = Color3.fromHex("#168633")
local BACKGROUND_DEFAULT_COLOR = Color3.fromHex("#c6825d")
...
local Typography: { [GuiTypography]: Typography } = {
	Headline1 = {
		Font = Font.fromName("LuckiestGuy", Enum.FontWeight.Bold, Enum.FontStyle.Normal),
		Scale = 6.0,
		TextWrapped = true,
	},
	Headline2 = {
	...
	Button = {
		Font = Font.fromName("Cartoon", Enum.FontWeight.Bold, Enum.FontStyle.Normal),
		Scale = 1.875,
		TextWrapped = false,
	},
	Body1 = {
